...
local function CreateWindow(utils, theme, flags, options, notificationSystem)
    ...
    local closeBtn = utils.create("TextButton", {
        ...
        TextSize = 22, Font = Enum.Font.Gotham,
        Parent = topBar,
    })
    ...
    closeBtn.MouseEnter:Connect(function()
        utils.tween(closeBtn, 0.2, {TextColor3 = theme.Colors.Error, BackgroundTransparency = 0, BackgroundColor3 = theme.Colors.L1})
    end)
    closeBtn.MouseLeave:Connect(function()
        utils.tween(closeBtn, 0.2, {TextColor3 = theme.Colors.TextSecondary, BackgroundTransparency = 1})
    end)
        ...
        local function selectTab()
            ...
            if activeTabBtn then
                ...
                if activeTabContent then
                    ...
                    t.Completed:Connect(function()
                        if activeTabContent ~= oldContent then
